...
---
_Kiritek Framework — skill core `git-workflow`. Adaptado de [netresearch/git-workflow-skill](https://github.com/netresearch/git-workflow-skill) (MIT + CC-BY-SA-4.0)._
