...
> **Kiritek:** estándar de state management es **BLoC/Cubit** (sección 5). Las secciones de Riverpod (6) quedan como referencia únicamente para proyectos legacy que ya lo usen — no iniciar features nuevas con Riverpod sin aprobación.
...
---
_Kiritek Framework — stack pack `flutter`. Adaptado de [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) (MIT)._
