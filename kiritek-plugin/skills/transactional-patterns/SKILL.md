...
clean way to publish domain events collected on an aggregate root.
...
---
_Kiritek Framework — stack pack `java-spring` (Spring Boot 3.x). Adaptado de [rrezartprebreza/spring-boot-skills](https://github.com/rrezartprebreza/spring-boot-skills) (MIT)._
