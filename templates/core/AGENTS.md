...
---
_Generado por `kiritek-init`. Editable — `kiritek-init update` no sobreescribe este archivo si ya existe. Formato universal (mismo contenido que `CLAUDE.md`), pa' herramientas que leen `AGENTS.md`._
