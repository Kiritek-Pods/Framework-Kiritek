...
---
_Kiritek Framework — stack pack `java-spring` (Spring Boot 3.x). Adaptado de [rrezartprebreza/spring-boot-skills](https://github.com/rrezartprebreza/spring-boot-skills) (MIT). Se eligió Flyway sobre Goose (mencionado en sesión con César) por ser el estándar nativo del ecosistema Spring — Goose se reevalúa si algún stack pack no-Java lo necesita._
